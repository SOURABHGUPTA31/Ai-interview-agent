          ...
          <div className="flex-1 px-6 py-20 ">
             ...
             <div className="text-center mb-24">
                ...
                className="text-4xl md:text-6xl font-semibold leading-tight max-w-4xl mx-auto">
                  ...
                  <span className="relative inline-block bg-green-100 text-green-600 px-5 py-1 rounded-full">
                    AI Intelligence
                  </span>
                  ...
                  [
                    {
                      ...
                      step:"Step-1",
                      title:"Role and Experiance selectiion",
                    ...
                    key={index} className={`relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl
                      ...
                      [
                        {
                          ...
                          desc:"Scores communication ttechnical accuracy and confidence"
                        },
                        {
                          image: resumeimg,
                          icon:<BsFileEarmarkText size={20} />,
                          title:"Resume Based Interview",
                          desc:"Project-specific quetions based on upload resume"
                        },
                        {
                          image:pdfimg,
                          icon:<BsFileEarmarkText size={20} />,
                          title:"Downloaded PDF Report",
                          desc:"Detailed Strengths, weaknesses and improvement ingsights"
                        },
                        {
                          image:historyimg,
                        ...
                        key={index} className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all">
                           <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="w-full md:w-1/2">
                              <div className="bg-green-50 text-green-600 w-12 h-12 rounded-xl flex item-center justify-center mb-6">
                                {item.icon}
                              </div>
                              <h3 className="font-semibold mb-3 text-xl">{item.title}</h3>
                              <p className="text-gray-500 text-sm leading-relaxed decoration-violet-50">{item.desc}</p>
                            </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-10">
                    {
                      [
                       ...
                       },
                       {
                        ...
                        desc:"Deep technical quetioning based on selected role"
                       },
                       {
                        img:confidenceimg,
